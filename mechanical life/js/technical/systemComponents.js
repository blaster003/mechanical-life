var systemComponents = {
	...
	'layer-tab': {
		...
		<div v-if="back"><button v-bind:class="back == 'big' ? 'other-back' : 'back'" v-on:click="goBack(layer)">&larr;</button></div>
    ...
    'options-tab': {
        ...
        <table>
            ...
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('offlineProd')">offline production: {{ options.offlineProd?"ON":"OFF" }}</button></td>
            </tr>
            <tr>
    ...
    'back-button': {
        template: `
        <button v-bind:class="back" onclick="goBack()">&larr;</button>
        `
    },
